# Encuesta UAT — Respuesta #02

> **Evaluador**: U02 · **Fecha**: 15 junio 2026 · ROA
...
| P0.3 | ¿Qué juegos has usado durante las pruebas? | **Last War, Mordheim** |
| P0.4 | ¿Con qué tecnología te sientes más cómodo/a? | **Usuario/a habitual de apps** |
...
- > La interfaz de Telegram ya la controlo así que no hubo curva de aprendizaje. La única pega es que escribir en medio de una partida es un poco lento.
- > Me gustaría poder mandarle un audio. Se agradecería mucho hablarle directamente al móvil.
...
- > No recuerdo ninguna respuesta directamente incorrecta aunque bastante largas, preferiría algo más directo.
- >
...
- > Lo prefiero a buscar en el reglamento, pero las respuestas son lentas.
- > Contesta en castellano auqnue el reglamento está en inglés.

**P3.6 (abierta)** — ¿Qué es lo que más echas de menos en el bot?
- > Que funcione también por voz. 
...
| P4.2 | Comparado con buscar en el libro o PDF, el bot te parece... | **Mejor** |
| P4.3 | Comparado con preguntar a otros jugadores, el bot te parece... | **Igual** |

**P4.4 (abierta)** — ¿Qué ventaja principal tiene el bot frente a cómo resuelves las dudas ahora?
- > No me hace falta abrir el PDF ni acordarme del capítulo. Pregunto en mis propias palabras y me responde. Además está disponible a las 3 de la mañana cuando preparo la lista.

**P4.5 (abierta)** — ¿Qué ventaja tiene tu método actual frente al bot?
- > Puedo buscar cmás eglas, interpretaciones o reglas de la casa en foros.
...
| P6.2 | ¿Cumple el bot su objetivo principal? | **Sí** |
...
- > Muy buen trabajo. Lo usaría ya mismo para evitar tener que leer en hereje. El único punto débil es que no recuerda el contexto de la conversación: si en el mismo chat le pregunto tres cosas seguidas sobre mi warband, la tercera pregunta no sabe nada de las dos anteriores. Estaría bien que tuviera algo de memoria del hilo de la sesión.
- > Y lo de la voz en serio.
