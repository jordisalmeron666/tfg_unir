# Encuesta UAT — Respuesta #01

> **Evaluador**: U01 · **Fecha**: 14 junio 2026 · Bigotes
...
| P0.2 | ¿Con qué frecuencia consultas un reglamento durante una partida? | **Con frecuencia** |
| P0.3 | ¿Qué juegos has usado durante las pruebas? | **Trench Crusade, Forbidden, Last War** |
| P0.4 | ¿Con qué tecnología te sientes más cómodo/a? | **Perfil no técnico** |
...
- > A veces tarda un poco más de lo esperado en respuestas que parecen sencillas. Nada crítico, pero se nota.
...
- > En Mordheim, al preguntar sobre las reglas de Carrera de Ratas en campaña, la respuesta era correcta pero le faltaba mencionar la excepción del héroe solitario. Nada grave.
- > En Trench Crusade todas las respuestas que hice fueron correctas y bien referenciadas.

**P2.8 (abierta)** — ¿Hubo preguntas que esperabas que el bot respondiera y no pudo?
- > Pregunté por una interacción específica de dos habilidades combinadas y el bot respondió con cada regla por separado pero no dedujo la interacción. Entiendo que es complejo.
- >
...
- > Poder preguntar sin tener que recordar cómo está estructurado el PDF.

**P3.6 (abierta)** — ¿Qué es lo que más echas de menos en el bot?
- > El historial de conversación. Si hago tres preguntas seguidas sobre la misma warband, el bot no recuerda las anteriores y tengo que repetir.
...
| # | Pregunta | Respuesta |
|---|----------|-----------|
| P4.1 | ¿Qué usas habitualmente para resolver dudas de reglas? | **PDF, Otros jugadores** |
| P4.2 | Comparado con buscar en el libro o PDF, el bot te parece... | **Un poco mejor** |
| P4.3 | Comparado con preguntar a otros jugadores, el bot te parece... | **Similar** |
...
- > Preguntar a otro jugador experto permite razonar la regla en contexto y llegar a interpretaciones consensuadas. El bot da la regla literal, lo que a veces no es suficiente.
...
- [x] El bot tardó demasiado en responder
- [ ] El bot no entendió mi pregunta
- [x] La respuesta fue correcta pero incompleta
...
- > Estaría bien poder mandarle un audio en lugar de escribir.
- > Que recordara el contexto de la conversación.
...
| # | Pregunta | Respuesta |
|---|----------|-----------|
| P6.1 | Valoración global del sistema | **7 / 10** |
| P6.2 | ¿Cumple el bot su objetivo principal? | **Sí, con matices** |
| P6.3 | ¿Lo usarías de forma regular si estuviera disponible? | **Sí** |

**P6.4 (abierta)** — Comentarios finales, sugerencias o cualquier cosa que quieras añadir.
- > Para partidas competitivas o torneos estaría bien un modo "respuesta rápida" q diera solo la respuesta concisa en segundos. No siempre necesito la explicación completa; a veces solo quiero el número o la excepción clave.
